...
const std::string CLIENT_FILEPATH = BASE_FILEPATH + "Multipath/cpp/results/client/2/";
const std::string SERVER_FILEPATH = BASE_FILEPATH + "Multipath/cpp/results/server/2/";
